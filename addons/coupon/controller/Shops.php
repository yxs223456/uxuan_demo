...
class Shops extends Controller{
    ...
    public function grantCoupon(){
        return $this->fetch("/home/shops/grantList");
    }
	/**
	 * 加载优惠券数据
	 */
	...
	public function grantCouponByPhone()
    {
        $couponId = input('id');
        $grantCouponPhone = input('grantCouponPhone');
        $m = new M();
        return $m->grantCouponByPhone($couponId, $grantCouponPhone);
    }
}