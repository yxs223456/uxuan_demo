...
class WeiBo {
    ...
    public function getToken(){
    	if($this->getEvn('expires_in')<time()){
	        $url = "https://api.weibo.com/oauth2/access_token?client_id=".$this->appId."&client_secret=".$this->appKey."&grant_type=authorization_code&code=".$this->code."&redirect_uri=".urlencode($this->callbackUrl);
