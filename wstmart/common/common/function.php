 ...
 * 核对验证码
 */
if (!function_exists('WSTVerifyCheck')) {
 ...
 */
if (!function_exists('WSTCheckFilterWords')) {
...
//php获取中文字符拼音首字母
if (!function_exists('WSTGetFirstCharter')) {
 ...
 * @param int 0-用户  1-商家
 */
if (!function_exists('WSTLoginTarget')) {
 ...
 * @return array
 */
if (!function_exists('WSTSendMail')) {
 ...
 * @param $key 要检测的内容
 */
if (!function_exists('WSTCheckLoginKey')) {
 ...
 * 生成随机数账号
 */
if (!function_exists('WSTRandomLoginName')) {
 ...
 */
if (!function_exists('WSTStrReplace')) {
 ...
 */
if (!function_exists('WSTGoodsCats')) {
 ...
 * 获取指定商品标签
 */
if (!function_exists('WSTGoodsTags')) {
    function WSTGoodsTags(){
        return Db::name('goods_tags')->where(['dataFlag'=>1, 'isShow' => 1])
                ->field("id,name")->order('weight asc')->select();
    }
}
 ...
 */
if (!function_exists('WSTUploadPic')) {
    function WSTUploadPic($fromType=0){
        ...
        if($info){
            ...
            $fileContent = file_get_contents(\Env::get('root_path') . $filePath . '/' . $filename);
            $fileUrl = \wstmart\common\helper\AliyunOss::putObject($filename, $fileContent);
            if ($isThumb==1) {
                $thumbContent = file_get_contents(\Env::get('root_path') . $filePath . '/' . $thumbSrc);
 ...
 * 上传文件
 */
if (!function_exists('WSTUploadFile')) {
    function WSTUploadFile(){
       ...
       // $info = $file->validate($rule)->rule('uniqid')->move(Env::get('root_path').'/upload/'.$dir."/".date('Y-m'));
        $info = $file->validate($rule)->check();
        if($info){
            $newFilename = $file->buildSaveName(true);
            $file = $file->filename;
            $fileUrl = \wstmart\common\helper\AliyunOss::putObject($newFilename, file_get_contents($file));
            $ossDomain = str_replace($newFilename,'',$fileUrl['url']);
            return json_encode(['status'=>1,'name'=>$newFilename,'route'=>$ossDomain]);
        }else{
            //上传失败获取错误信息
 ...
 * 上传文件
 */
if (!function_exists('WSTUploadApk')) {
    function WSTUploadApk(){
        $fileKey = key($_FILES);
        $dir = Input('post.dir');
        if($dir=='')return json_encode(['msg'=>'没有指定文件目录！','status'=>-1]);
        $dirs = WSTConf("CONF.wstUploads");
        ...
        $info = $file->validate($rule)->rule('uniqid')->move(Env::get('root_path').'/upload/'.$dir."/".$dir);
        if($info){
            //保存路径
            $filePath = $info->getPathname();
            $filePath = str_replace(Env::get('root_path'),'',$filePath);
 ...
 * 上传视频
 */
if (!function_exists('WSTUploadVideo')) {
 ...
 * 获取订单统一流水号
 */
if (!function_exists('WSTOrderQnique')) {
...
* 
*/
if (!function_exists('WSTRecordImages')) {
    function WSTRecordImages($imgPath, $fromType){
        ...
        $image = addImgDomain($imgPath);
        $imgInfo = json_encode(getimagesize($image), JSON_UNESCAPED_UNICODE);
        //获取表名
...
*/
if (!function_exists('WSTUseImages')) {
...
* @param $newDesc       新商品描述
*/
if (!function_exists('WSTEditorImageRocord')) {
...
* 标记删除图片
*/
if (!function_exists('WSTUnuseImage')) {
 ...
 * 获取系统根目录
 */
if (!function_exists('WSTRootPath')) {
 ...
 * @param @shopIds 店铺ID
 */
if (!function_exists('WSTOrderFreight')) {
 ...
 * 获取支付方式
 */
if (!function_exists('WSTLangPayType')) {
 ...
 * 收货方式
 */
if (!function_exists('WSTLangDeliverType')) {
 ...
 * 订单状态
 */
if (!function_exists('WSTLangOrderStatus')) {
 ...
 * 积分来源
 */
if (!function_exists('WSTLangScore')) {
 ...
 * 资金来源
 */
if (!function_exists('WSTLangMoneySrc')) {
 ...
 * 投诉状态
 */
if (!function_exists('WSTLangComplainStatus')) {
 ...
 * 支付来源
 */
if (!function_exists('WSTLangPayFrom')) {
 ...
 * 插件状态
 */
if (!function_exists('WSTLangAddonStatus')) {
 ...
 * 获取消息模板
 */
if (!function_exists('WSTMsgTemplates')) {
 ...
 * 发送微信消息
 */
if (!function_exists('WSTWxMessage')) {
 ...
 * 批量发送微信消息
 */
if (!function_exists('WSTWxBatchMessage')) {
...
if (!function_exists('WSTShopEncrypt')) {
 ...
 * 根据子分类循环获取其父级分类
 */
if (!function_exists('WSTGoodsCatPath')) {
...
* 编辑器上传图片
*/
if (!function_exists('WSTEditUpload')) {
 ...
 * 转义单引号
 */
if (!function_exists('WSTHtmlspecialchars')) {
 ...
 * 获取分类的佣金
 */
if (!function_exists('WSTGoodsCommissionRate')) {
...
if (!function_exists('WSTFormatIn')) {
 ...
 * 金额兑积分
 */
if (!function_exists('WSTMoneyGiftScore')) {
 ...
 */
if (!function_exists('WSTScoreToMoney')) {
 ...
 * 头像处理
 */
if (!function_exists('WSTUserPhoto')) {
...
if (!function_exists('WSTClearHookCache')) {
 ...
 * 获取移动端首页按钮
 */
if (!function_exists('WSTMobileBtns')) {
 ...
 */
if (!function_exists('WSTBase64url')) {
 ...
 * 判断访问端来源
 */
if (!function_exists('WSTVisitModule')) {
...
* @imgUrl 图片地址
*/
if (!function_exists('WSTImgColor')) {
 ...
 * 获取用户等级
 */
if (!function_exists('WSTUserRank')) {
...
* 增加文章访问数
*/
if (!function_exists('WSTArticleVisitorNum')) {
 ...
 * 保持数值为大于0的数值
 */
if (!function_exists('WSTPositiveNum')) {
 ...
 */
if (!function_exists('WSTStrToTime')) {
 ...
 * 计算剩余时间
 */
if (!function_exists('WSTTimeToStr')) {
 ...
 * 获取订单来源模块
 */
if (!function_exists('WSTOrderModule')) {
 ...
 */
if (!function_exists('WSTClearAllCache')) {
    function WSTClearAllCache(){
        Cache::clear();
    }
}

if (!function_exists('WSTShopOrderMenus')) {
...
if (!function_exists('WSTIpLocation')) {
 ...
 * 分词
 */
if (!function_exists('WSTAnalysis')) {
...
if (!function_exists('WSTGroupGoodsSearchKey')) {
 ...
 * 获取https设置情况
 */
if (!function_exists('WSTProtocol')) {
 ...
 * 获取毫秒级别的时间戳
 */
if (!function_exists('WSTGetMillisecond')) {
 ...
 * reids缓存使用：每整5分钟key值
 */
if (!function_exists('get5MinuteDateKey')) {
    function get5MinuteDateKey() {
        $now = time();
        $currentMinute = date('i', $now);
        return date('YmdH', $now)  . (bcdiv($currentMinute,5,0) * 5);
    }
}
/**
 * reids缓存使用：上一个整5分钟key值
 */
if (!function_exists('getPre5MinuteDateKey')) {
    function getPre5MinuteDateKey() {
        $time = time() - 300;
        $minute = date('i', $time);
        return date('YmdH', $time)  . (bcdiv($minute,5,0) * 5);
    }
}
/**
 * 生成拼团号
 */
if (!function_exists('tuanNo')) {
    function tuanNo($tuanId, $headUserId) {
        $tuanNo = md5(time() . $tuanId . 'a' . $headUserId . mt_rand(10000, 99999));
        return $tuanNo;
    }
}
if (!function_exists('addImgDomain')) {
    function addImgDomain($imgPath) {
        if (stripos($imgPath, 'http') === 0 || empty($imgPath)) {
