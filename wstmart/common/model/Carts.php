...
class Carts extends Base{
	...
	public function getQuickCarts($uId=0){
		...
		//店铺优惠活动监听
		hook("afterQueryCarts",["carts"=>&$cartData,'isSettlement'=>true,'isVirtual'=>true,'uId'=>$uId]); 
		return $cartData; 
	}
	...
	public function getCarts($isSettlement = false, $uId=0){
		...
		$cartData = ['carts'=>$carts,'goodsTotalMoney'=>$goodsTotalMoney,'goodsTotalNum'=>$goodsTotalNum,'promotionMoney'=>0]; 
		//店铺优惠活动监听
		hook("afterQueryCarts",["carts"=>&$cartData,'isSettlement'=>$isSettlement,'isVirtual'=>false,'uId'=>$uId]); 
		return $cartData;   
	}
