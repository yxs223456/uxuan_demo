...
function initUploads(){
	...
	var uploads = ['watermarkFile','mallLogo','shopLogo','shopAdtop','userLogo','goodsLogo','guideImageOne','guideImageOne','guideImageTwo','guideImageThree','guideVideo'],key;
	for(var i=0;i<uploads.length;i++){
		...
		WST.upload({
			  k:key,
		  	  ...
		  	  accept: {extensions: 'jpg,jpeg,png,gif',mimeTypes: 'audio/*,image/jpg,image/jpeg,image/png,image/gif'},
		  	  callback:function(f){
