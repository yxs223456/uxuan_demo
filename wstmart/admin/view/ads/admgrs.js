...
function initGrid(){
  ...
  var cols = [
          ...
          {title:'是否上线', name:'isShow', width: 10,renderer: function(val,item,rowIndex){
              return (val==1 ? '是' : '否');
          }},
...
function toggleIsShow( goodsId, isAudit){
    $.post(WST.U('admin/ads/setToggle'), {'adId':adId, 'isShow':isShow}, function(data, textStatus){
